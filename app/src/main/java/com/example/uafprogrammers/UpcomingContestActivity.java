...
public class UpcomingContestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtStatus = findViewById(R.id.txtStatusContestActivity);

        contestListview = findViewById(R.id.listview_upcoming_contests);

        contestArrayList = new ArrayList<>();

        firebaseDatabase = FirebaseDatabase.getInstance();

        databaseReference = firebaseDatabase.getReference().child("UpcomingContests");

        contestListAdapter = new ContestListAdapter(UpcomingContestActivity.this, contestArrayList);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                try{
                    ...
                    if (contestArrayList.size() > 0){
                        ...
                        txtStatus.setText("No Contests Here...");
